...
export default function OrdersScreen() {
  ...
  const activeOrders = state.pendingOrders.filter(
    (o) => o.localStatus && ['new', 'scanning', 'matched', 'sync_pending', 'review_required', 'confirmed_local', 'rejected_local', 'syncing'].includes(o.localStatus)
  );
...
function orderStatusMeta(order: Order): {
  ...
  switch (order.localStatus) {
    ...
    case 'syncing':
      return { label: 'جاري المزامنة', bgColor: '#dbeafe', textColor: '#1e40af' };
    case 'error':
