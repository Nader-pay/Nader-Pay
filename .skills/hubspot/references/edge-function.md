...
const actions = {
  ...
  search_contacts: {
    url: "https://app-dz8miw66l2wx-api-connect-hubspot-search-contacts.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_companies: {
    url: "https://app-dz8miw66l2wx-api-connect-hubspot-search-companies.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_deals: {
    url: "https://app-dz8miw66l2wx-api-connect-hubspot-search-deals.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
