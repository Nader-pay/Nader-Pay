...
**Endpoint:** `GET https://app-dz8miw66l2wx-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-dz8miw66l2wx-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
