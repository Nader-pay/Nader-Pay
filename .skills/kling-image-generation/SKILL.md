...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-dz8miw66l2wx-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations` |
| Query Task Endpoint | `GET https://app-dz8miw66l2wx-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}` |
